...
namespace PhenomTools
{
    ...
    public class DictionaryPropertyDrawer : PropertyDrawer
    {
        ...
        private SerializedProperty GetReferences(SerializedProperty property)
        {
            ...
            list = GetTargetObjectOfProperty(listProp) as ReorderableList_SD;
        ...
        public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
        {
            ...
            if (list != null)
            {
                if (!list.HasList)
                {
                    list = new ReorderableList_SD(KeysProp, true, true, true);
        ...
        private void List_onAddCallback(ReorderableList_SD list)
        {
        ...
        private void List_onRemoveCallback(ReorderableList_SD list)
        {
