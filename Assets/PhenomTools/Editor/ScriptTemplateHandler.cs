...
public static class ScriptTemplateHandler
{
    ...
    {
        ProjectWindowUtil.CreateScriptAssetFromTemplateFile(string.Concat(Application.dataPath.Remove(Application.dataPath.Length - 7), "/Templates/PhenomTemplates-NewClass.cs.txt"), "NewMonobehavior.cs");
    }
