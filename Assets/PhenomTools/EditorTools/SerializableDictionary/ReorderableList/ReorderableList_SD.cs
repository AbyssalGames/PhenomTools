...
{
    [System.Serializable]
    public class ReorderableList_SD
    {
#if UNITY_EDITOR
        ...
        public delegate void ActionDelegate(ReorderableList_SD list);
        public delegate bool ActionBoolDelegate(ReorderableList_SD list);
        ...
        public delegate void AddDropdownDelegate(Rect buttonRect, ReorderableList_SD list);
        public delegate void DragDropAppendDelegate(Object reference, ReorderableList_SD list);
        ...
        public delegate Object DragDropReferenceDelegate(Object[] references, ReorderableList_SD list);
        public delegate float GetElementHeightDelegate(SerializedProperty element, int index);
        public delegate float GetElementsHeightDelegate(ReorderableList_SD list);
        ...
        public ReorderableList_SD(SerializedProperty keys)
            : this(keys, true, true, true) { }

        public ReorderableList_SD(SerializedProperty list, bool canAdd, bool canRemove, bool draggable)
            : this(list, canAdd, canRemove, draggable, ElementDisplayType.Auto, null, null, null) { }

        public ReorderableList_SD(SerializedProperty list, bool canAdd, bool canRemove, bool draggable, ElementDisplayType elementDisplayType, string elementNameProperty, Texture elementIcon)
            : this(list, canAdd, canRemove, draggable, elementDisplayType, elementNameProperty, null, elementIcon) { }

        public ReorderableList_SD(SerializedProperty list, bool canAdd, bool canRemove, bool draggable, ElementDisplayType elementDisplayType, string elementNameProperty, string elementNameOverride, Texture elementIcon)
        {
            if (list == null)
            {
