...
namespace GetSocialSdk.Core 
{
  ...
  [Serializable]
  #endif
  public partial class GetUsersRequest : TBase
  {
    ...
    /// <summary>
    /// This filter must not be used in combination with other filters.
    /// </summary>
    ...
    public void Write(TProtocol oprot) {
      ...
      try
      {
        TStruct struc = new TStruct("GetUsersRequest");
        ...
        if (__isset.suggested) {
          field.Name = "suggested";
          field.Type = TType.Bool;
          field.ID = 5;
          oprot.WriteFieldBegin(field);
          oprot.WriteBool(Suggested);
          oprot.WriteFieldEnd();
        }
    ...
    public override string ToString() {
      StringBuilder __sb = new StringBuilder("GetUsersRequest(");
      bool __first = true;
      if (SessionId != null && __isset.sessionId) {
