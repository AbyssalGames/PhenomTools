...
namespace GetSocialSdk.Core 
{
  ...
  [Serializable]
  #endif
  public partial class GetSuggestedUsersResponse : TBase
  {
    private List<THSuggestedUser> _users;
    private int _totalNumber;
    private string _nextCursor;

    public List<THSuggestedUser> Users
    {
      get
      {
        return _users;
    ...
    public GetSuggestedUsersResponse() {
    }
          ...
          switch (field.ID)
          {
            case 1:
              if (field.Type == TType.List) {
                {
                  Users = new List<THSuggestedUser>();
                  TList _list51 = iprot.ReadListBegin();
                  for( int _i52 = 0; _i52 < _list51.Count; ++_i52)
                  {
                    THSuggestedUser _elem53;
                    _elem53 = new THSuggestedUser();
                    _elem53.Read(iprot);
                    Users.Add(_elem53);
                  }
                  iprot.ReadListEnd();
    ...
    public void Write(TProtocol oprot) {
      ...
      try
      {
        TStruct struc = new TStruct("GetSuggestedUsersResponse");
        ...
        if (Users != null && __isset.users) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (THSuggestedUser _iter54 in Users)
            {
              _iter54.Write(oprot);
            }
            oprot.WriteListEnd();
    ...
    public override string ToString() {
      StringBuilder __sb = new StringBuilder("GetSuggestedUsersResponse(");
      bool __first = true;
      if (Users != null && __isset.users) {
