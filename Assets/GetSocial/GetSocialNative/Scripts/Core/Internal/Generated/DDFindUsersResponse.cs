...
namespace GetSocialSdk.Core 
{
  ...
  [Serializable]
  #endif
  public partial class DDFindUsersResponse : TBase
  {
              ...
              if (field.Type == TType.List) {
                {
                  ...
                  {
                    THPublicUser _elem70;
                    _elem70 = new THPublicUser();
                    _elem70.Read(iprot);
                    Users.Add(_elem70);
                  }
                  iprot.ReadListEnd();
    ...
    public void Write(TProtocol oprot) {
      ...
      try
      {
        TStruct struc = new TStruct("DDFindUsersResponse");
        ...
        if (Users != null && __isset.users) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (THPublicUser _iter71 in Users)
            {
              _iter71.Write(oprot);
            }
            oprot.WriteListEnd();
    ...
    public override string ToString() {
      StringBuilder __sb = new StringBuilder("DDFindUsersResponse(");
      bool __first = true;
      if (Users != null && __isset.users) {
