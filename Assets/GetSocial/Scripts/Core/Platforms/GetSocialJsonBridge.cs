...
#region Push notifications
        ...
        public void RegisterDevice() {
            CallSyncVoid("Notifications.registerDevice", "");
        }
        ...
        private void CallSyncVoid(string method, string body)
        {
            MethodCaller.CallVoid(method, body);
        }
    ...
    internal interface IMethodCaller
    {
        ...
        void CallVoid(string method, string body);
