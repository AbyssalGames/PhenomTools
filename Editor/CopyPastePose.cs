...
public static class CopyPastePose
{
    [System.Serializable]
    public class TransformInfo
    {
        ...
        {
            sb.Append(string.Format("{0}|{1},{2},{3},{4},{5},{6}", name, rotation.x, rotation.y, rotation.z, position.x, position.y, position.z));
    ...
    [MenuItem("PhenomTools/Copy Paste Pose/Copy Pose")]
    ...
    [MenuItem("PhenomTools/Copy Paste Pose/Copy Pose", true)]
    static bool ValidateCopyPose()
    {
        return Selection.activeTransform != null;
    }

    [MenuItem("PhenomTools/Copy Paste Pose/Paste Pose")]
    ...
    [MenuItem("PhenomTools/Copy Paste Pose/Paste Pose", true)]
