...
namespace PhenomTools
{
    ...
    /// </summary>
    public class VerticalLayoutGroupExtended : HorizontalOrVerticalLayoutGroup
    {
        ...
        public override void SetLayoutHorizontal()
        {
            ...
            SetChildrenAlongAxisWithReverse(0, true, false);
        }
        ...
        {
            SetChildrenAlongAxisWithReverse(1, true, m_IsReverse);
        }
        ...
        protected void SetChildAlongAxisWithScaleAndDirection(RectTransform rect, int axis, bool reverse, float pos, float size, float scaleFactor)
        {
            ...
            if (axis == 1)
            {
                rect.anchorMin = reverse ? BottomLeft : TopLeft;
                rect.anchorMax = reverse ? BottomLeft : TopLeft;
            }
        ...
        protected void SetChildAlongAxisWithScaleAndDirection(RectTransform rect, int axis, bool isReverse, float pos, float scaleFactor)
        {
            ...
            if (axis == 1)
            {
                rect.anchorMin = isReverse ? BottomLeft : TopLeft;
                rect.anchorMax = isReverse ? BottomLeft : TopLeft;
            }
